...
for row in reader:
	...
	htmlfile.write('<td class="ck_border" height="21" style="height: 21px; padding: 2px; border: 1px solid rgb(221, 221, 221);"><a href="'+LINK+'">'+TITLE+'</a></td><td align="right" class="ck_border" style="padding: 2px; border: 1px solid rgb(221, 221, 221);">'+YEAR+'</td><td align="right" class="ck_border" style="padding: 2px; border: 1px solid rgb(221, 221, 221);">'+DATE+'</td>')
...
with open('swank-table.html',"w") as prettyfile:
